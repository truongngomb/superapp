 ...
 * 
 * Skeleton loading state for MarkdownPageRow.
 */
export function MarkdownPageSkeleton() {
  return (
    <div className="px-1 py-1">
      <div className="card p-4 flex flex-col md:flex-row items-start md:items-center gap-4 border border-border bg-card rounded-lg">
